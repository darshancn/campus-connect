...
class NewMatchTab extends StatelessWidget {
  const NewMatchTab({super.key});

  final List<Map<String, String>> users = const [
    {
      'image': 'assets/images/new_match1.png',
      'name': 'Léa Rossi, 36',
      'distance': '2km',
      'tag': 'none',
    },
    {
      'image': 'assets/images/new_match2.png',
      'name': 'Sofia Lee, 29',
      'distance': '4km',
      'tag': 'none',
    },
    {
      'image': 'assets/images/new_match3.png',
      'name': 'Maria Kim, 31',
      'distance': '3km',
      'tag': 'premium',
    },
    {
      'image': 'assets/images/new_match4.png',
      'name': 'Isabelle Wu, 28',
      'distance': '6km',
      'tag': 'gold',
    },
